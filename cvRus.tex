...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
 \item Языки программирования:  C++(11), Python (pandas, numpy, scikit-learn, tensorflow, keras), Wolfram Mathematica, C, Assembler
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
 \item \href{https://credit-risks.asciishell.ru/}{Программный модуль для управления кредитными рисками банка} - командный проект. Роль в проекте: тим-лидер, математическое исследование, программирование (логистическая регрессия).
