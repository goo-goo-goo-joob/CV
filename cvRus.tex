...
\textbf{\Large Самоделкина Мария} & Tel: +7(985) 733-61-91 \\
21 год, Москва & E-mail: samodelkina.m.v@yandex.ru \\
...
\begin{itemize}
	...
	\resitem{Топ рейтинга}
	\resitem{Майнор <<Интеллектуальный анализ данных>>}
\end{itemize}
...
\begin{itemize}
 ...
 \item Программы: Git, SQL, Unix, \LaTeX %, MS Office
...
\begin{itemize}
	...
	\begin{itemize}
		\resitem{Подготовка методических материалов}
		\resitem{Верстка в \LaTeX}
	\end{itemize}
	\item Стажер-аналитик в Тинькофф Банке \cftdotfill{\cftdotsep} 2020
	\begin{itemize}
		\resitem{Анализ данных, работа с аудиозаписями}
		\resitem{Разработка моделей машинного обучения на Python}
		\resitem{Нейронные сети для классификации аудиозаписей на Tensorflow}
	\end{itemize}
	\item Стажер-исследователь в	 научно-учебной лаборатории телекоммуникационных систем МИЭМ НИУ ВШЭ \cftdotfill{\cftdotsep} 2018-2019
	\begin{itemize}
		\resitem{Работа с научной литературой}
		\resitem{Изучение алгоритмов легковесной криптографии}
	\end{itemize}
\end{itemize}
...
%\begin{itemize}
	%\resitem {Линейные модели, решающие деревья, кластеризация, нейронные сети}
	%\resitem {Рекомендательные системы, A/B-тесты, временные ряды}
	%\resitem {Метрики качества}
%\end{itemize}
	%\item \href{https://www.coursera.org/account/accomplishments/verify/HZUM6J562K5G?utm_campaign=social_icons&utm_content=cert_image&utm_medium=certificate&utm_product=course&utm_source=link&utm_user=8ec555795f34e35d36b3a63479f4103f5766c300}{Introduction to numerical analysis}
	%\item \href{https://intuit.ru/verifydiplomas/101343520}{Основы SQL}
	%\item \href{https://www.coursera.org/account/accomplishments/verify/Q2FNBYS2YQEQ?utm_campaign=social_icons&utm_content=cert_image&utm_medium=certificate&utm_product=course&utm_source=link&utm_user=8ec555795f34e35d36b3a63479f4103f5766c300}{How to Win a Data Science Competition: Learn from Top Kagglers}
%\end{itemize}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
